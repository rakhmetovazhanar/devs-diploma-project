    ...
    const fetchData = async () => {
      try {
        const [studentsResponse, coursesResponse, feedbacksResponse, teachersResponse] = await Promise.all([
          axios.get('https://genuis.tech/api/students-number/'),
          axios.get('https://genuis.tech/api/courses-number/'),
          axios.get('https://genuis.tech/api/comments-number/'),
          axios.get('https://genuis.tech/api/teachers-number/'),
        ]);
