    ...
    const fetchData = async () => {
      try {
        const [studentsResponse, coursesResponse, feedbacksResponse] = await Promise.all([
          axios.get(`https://genuis.tech/api/students/${user.user_id}`, {
            headers: {
              Authorization: `Token ${token}`,
              'Content-Type': 'application/json'
            }
          }),
          axios.get(`https://genuis.tech/api/courses/${user.user_id}`, {
            headers: {
              Authorization: `Token ${token}`,
              'Content-Type': 'application/json'
            }
          }),
          axios.get(`https://genuis.tech/api/feedback/${user.user_id}`, {
            headers: {
              Authorization: `Token ${token}`,
              'Content-Type': 'application/json'
            }
                ...
                <div className={styles.profile}>
                  ...
                  <div className={styles.profile_content}>
                    ...
                    {teacherData && teacherData.profile_picture ? (
                          <img className={styles.user_img} src={`https://genuis.tech${teacherData.profile_picture}`} alt="Profile" />
                      ) : (
