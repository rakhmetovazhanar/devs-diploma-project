          ...
          <div className={styles.container}>
            ...
            <div className={styles.joinMeet_content}>
              <div className={styles.inner_joinMeet}>
                ...
                <p className={styles.joinMeet_subtitle}>Подключайтесь, сотрудничайте и отмечайте события из любой точки
                  мира с помощью Видео Конференций.</p>
              ...
              <Link to='/student-courses'>
                <button className={styles.prevPage}>Назад</button>
              </Link>
            </div>
          </div>
          <Footer/>
